...
- Total: 15 (Declared: 15, Class methods: 0)
- Functions: areTimeSignaturesEquivalent, cleanupLoopPlayer, findMatchingLoopSet, getEffectiveKey, getLoopPlayerHTML, getLoopsMetadata, **getSavedLoopTempoPercent**, getTransposeLevel, initializeLoopPlayer, invalidateLoopsMetadataCache, normalizeKeyName, parseLoopRhythmSetId, shouldShowLoopPlayer, toggleLoopPlayer, updateMelodicPadAvailability
